  ...
  char * sz_clients_multicast_address)
{
  ...
  // TODO(Gergely Kovacs) address storing needs to be implemented
  // if client communication is going to be enabled
...
int CortexMock::copyFrame(const sFrameOfData * p_src, sFrameOfData * p_dst)
{
  ...
  for (int i = 0; i < n_bodies; i++) {
    ...
    // TODO(Gergely Kovacs) test this and
    // other functionalities too which aren't tested by capture files
