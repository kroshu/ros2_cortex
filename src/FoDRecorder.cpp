...
rapidjson::Document json_doc;  // TODO(Gergely Kovács) not global...
  ...
  rapidjson::Document::AllocatorType & allocator)
{
  ...
  for (int iBody = 0; iBody < nBodies; iBody++) {
    ...
    // TODO(Gergely Kovács) check whether this is safe
...
{
  // TODO(Gergely Kovács) maybe instead get as param??
